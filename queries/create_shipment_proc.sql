...
CREATE OR REPLACE PROCEDURE CREATE_NEW_SHIPMENT(V_REQUEST_ID IN NUMBER, V_INVEN_ID IN NUMBER, V_REGION_ID IN NUMBER) IS
...
BEGIN
    ...
    FOR PR IN (SELECT PRODUCT_ID PID, NVL(SUPPLIABLE_AMOUNT,0) Q FROM SHIPMENT_REQUEST_PRODUCT WHERE REQUEST_ID=V_REQUEST_ID) LOOP
        ...
        IF PR.Q > 0 THEN
            ...
            UPDATE PRODUCT_ALLOTEMENT SET AMOUNT = AMOUNT-v_shipping_amount
